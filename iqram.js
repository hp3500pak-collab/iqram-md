...
const port = por.PORT;
const ownerNumber = ["923108238069"];
if (!app) return;
// Session directory
...
async function sessdl() {
  try {
    ...
    const base64Data = sess.SESSION_ID.split("IQRAM-XPRO~")[1];
    if (!base64Data) {
...
async function connectToWA() {
  ...
  //===========================
  console.log("🔥 ɪQʀᴀᴍxᴍᴅ is starting...");
  ...
  conn.ev.on("connection.update", (update) => {
    ...
    if (connection === "close") {
      ...
      let up = `
          🚀 **© ɪQʀᴀᴍxᴍᴅ 𝗑ᴾᴿᴼ 💚 Connected Successfully!** ✅ 
          
          --- **🎉 Welcome to © ɪQʀᴀᴍxᴍᴅ 𝗑ᴾᴿᴼ 💚!** 🎉 
          ...
          --- Thank you for using **© ɪQʀᴀᴍxᴍᴅ 𝗑ᴾᴿᴼ 💚**. 
...
if (!app) return;
app.get("/", (req, res) => {
  res.send("hey I am alive, IQRAM-MD Is started✅");
});
app.listen(port, () =>
